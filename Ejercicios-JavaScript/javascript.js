...
let Test = "Hello World"
 ...
 Traducido = Test.replace(
   Test.toUpperCase.length[0],
  // CodMorse.Test.toUpperCase.length[0]
 );
 ...
 for (let i = 0; i < Test.length; i++) {
  var letra = Object.values(Test)[i]
  letra.map(x => {CodMorse[x]} )

  // console.log(CodMorse.e);
