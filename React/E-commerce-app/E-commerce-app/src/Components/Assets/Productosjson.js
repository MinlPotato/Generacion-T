import manzana from "./manzana_roja.png";
import banana from "./banana.png";
import sandia from "./sandia.png";
import naranja from "./naranja.png"
import piña from "./piña.png"
import frutilla from "./frutilla.png"
...
export const productos = [
  ...
  },
  {
    ...
    precio: 100,
    precioTotal: 0,
    desc: "Es una planta herbácea de ciclo anual, trepadora o rastrera, de textura áspera, con tallos pilosos provistos de zarcillos y hojas de cinco lóbulos profundos. Las flores son amarillas, grandes y unisexuales, las femeninas tienen el gineceo con tres carpelos, y las masculinas con cinco estambres. El fruto de la planta es grande (normalmente más de cuatro kilos), pepónide, carnoso y jugoso (más del 90% es agua), casi esférico, de textura lisa y sin porosidades, de color verde en dos o más tonos. La pulpa es de color rojo —por el antioxidante licopeno— y de carne de sabor generalmente dulce (más raramente amarilla y amarga). Las numerosas semillas pueden llegar a medir 1 cm de longitud, son de color negro, marrón o blanco y ricas en vitamina E, se han utilizado en medicina popular y también se consumen tostadas como alimento.",
  },
  {
    id: "4",
    name: "naranja",
